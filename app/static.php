    ...
    <div id="content">
        ...
        <div id="body">
	       	<div class="searchForm">
				<input type="text" id="search_value" readonly value="<?=(isset($_GET['artist']) ? $_GET['artist'] : '');?>" placeholder="Search for an artist" />
				<input id="confirmSearch" type="button" value="Search" /><br /><br />
				Traveling from: <input type="text" readonly id="search_location" value="<?=(isset($_GET['location']) ? $_GET['location'] : '');?>" placeholder="Your location" />
                arriving about <input type="text" readonly id="search_early" value="<?=(isset($_GET['early']) ? $_GET['early'] : '30');?>" /> minutes early                
			</div>
